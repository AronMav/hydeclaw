...
Plans:
- [x] 48-01-PLAN.md — OPTI-01/02 regression tests + shared MessageSkeleton component
- [x] 48-02-PLAN.md — Content hash reconciliation for live-to-history transition (OPTI-03/04)
- [x] 48-03-PLAN.md — Human verification checkpoint (deferred)
**UI hint**: yes
